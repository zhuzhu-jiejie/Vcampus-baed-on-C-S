...
public class TestCourse implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1945959392771226306L;
    ...
    public TestCourse(String NAME, String TEACHERNAME, double CREDIT, String ACADEMY, String MAJOR,
    		int FIRSTWEEK, int LASTWEEK, int STUDENTTYPE, int STUDENTNUM, String ID, String NATURE, String DEPARTMENT) {
    	name = NAME;             
